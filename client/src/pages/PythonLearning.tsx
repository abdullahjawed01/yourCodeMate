...
import {
  ...
  ArrowRight, Play, Trophy, ChevronDown
} from 'lucide-react';
...
const PythonLearning: React.FC = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['pythonTopics'],
    queryFn: pythonApi.getTopics,
  });

  const completeMutation = useMutation({
    mutationFn: (topicId: string) => pythonApi.completeTopic(topicId),
    onSuccess: () => {
    ...
    return (
      <div className="flex h-96 items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-zinc-500">Loading your journey...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 pb-12">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-950 text-white p-8 lg:p-12 shadow-2xl">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          >
            ...
            <p className="text-zinc-300 text-lg mb-8 leading-relaxed">
              A comprehensive interactive path to mastering Python.
              Complete lessons, pass coding tests, and earn certification badges.
            </p>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-zinc-400">Topics Completed</div>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        {topics.map((topic: any, index: number) => (
          <motion.div
            ...
            className={clsx(
              ...
              topic.isCurrent && "ring-2 ring-primary ring-offset-2 dark:ring-offset-zinc-900"
            )}
            onClick={() => {
              ...
              <div className="flex justify-between items-start mb-4">
                <div className={clsx(
                  ...
                  topic.completed ? "bg-green-100 dark:bg-green-900/20 text-green-600 dark:text-green-400" :
                    topic.unlocked ? "bg-primary/10 text-primary" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-400"
                )}>
                  ...
                  <div className="flex gap-4">
                    ...
                    {selectedTopic.testId && (
                      <button
                        ...
                        className="px-6 py-2 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground font-medium shadow-lg hover:shadow-xl transition-all active:scale-95 flex items-center gap-2"
                      >
