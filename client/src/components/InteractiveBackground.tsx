...
const InteractiveBackground = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[-1] overflow-hidden">
        ...
        <motion.div 
            style={{ y: y2 }}
            className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vh] rounded-full blur-[100px] bg-accent/10 opacity-40 animate-float-delayed"
        />

        {/* Floating Geometric Particles */}
        <div className="absolute inset-0">
             {/* Use simple svgs or divs for particles */}
             <motion.div 
                animate={{ 
                    y: [0, -20, 0],
                    rotate: [0, 360],
